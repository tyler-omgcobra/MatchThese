...
import org.omgcobra.matchthese.tabs.item.ItemWithTagsTabFragment
import org.omgcobra.matchthese.tabs.tag.TagWithItemsTabFragment
...
class TabHostFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        tabs = listOf(
                ItemWithTagsTabFragment(getString(R.string.items_tab_title)),
                TagWithItemsTabFragment(getString(R.string.tags_tab_title))
        )
